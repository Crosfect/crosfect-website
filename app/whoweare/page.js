                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative">
                  <div className="flex flex-col items-center justify-center py-10 lg:py-6">
                    ...
                    <div className='flex flex-col gap-5 pt-6 text-center'>
                        <h1 className='lg:text-7xl font-bold'>This Is <span className='text-blue-600'>Crosfect</span></h1>
                        <p className=' text-xl lg:px-10'>We are empowering businesses with cutting-edge AI, blockchain, and Web3 solutions. We build
scalable, intelligent, and future-proof digital experiences.
</p>
                    </div>
